...
function checkDeprecation(argv) {
  if (argv.dev === false) {
    (0, _deprecate.default)('The option `dev` is deprecated. It leads a wrong result for missing dependencies' + ' when it is `false`. This option will be removed and enforced to `true` in next' + ' major version.');
  }
}
