let buntstift,EVENTS,express,Game,Player,Server,socket;_90d‍.w("buntstift",[["default",["buntstift"],function(v){buntstift=v}]]);_90d‍.w("../events",[["default",["EVENTS"],function(v){EVENTS=v}]]);_90d‍.w("express",[["default",["express"],function(v){express=v}]]);_90d‍.w("./game/Game",[["default",["Game"],function(v){Game=v}]]);_90d‍.w("./player/Player",[["default",["Player"],function(v){Player=v}]]);_90d‍.w("http",[["Server",["Server"],function(v){Server=v}]]);_90d‍.w("socket.io",[["default",["socket"],function(v){socket=v}]]);
...
io.on('connect', socketServer => {
  ...
  socketServer.on(EVENTS.DISCONNECT, () => {
    game.objects.forEach(object => {
      if (object) {
        _90d‍.g.console.log(object);
        _90d‍.g.console.log(object.player.id, socket.id);
