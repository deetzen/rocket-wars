...
(function() {
    ...
    Promise.all([
        ...
        spriteLibrary.addSprite('game-background-1', 'images/backgrounds/background_04_parallax_01.png', 2448, 1936, 0)
    ]).then(() => {
        ...
        socket.on(UPDATE_OBJECTS, function (objects) {
            ...
            for(let object in objects) {
                ...
                let shieldSkin = spriteLibrary.sprites.get('shield');
                newObject.setShieldSkin(new Skin(shieldSkin, 0));
